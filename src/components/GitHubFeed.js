    ...
    if (!Array.isArray(repos) || repos.length === 0) {
      this.container.innerHTML = `
        <div class="gh-empty-box">
          ...
          <a href="${this.profileUrl}" target="_blank" rel="noopener noreferrer" class="os-btn os-btn-secondary">
  ...
  renderFallback() {
    if (this.profileCard) {
      this.profileCard.innerHTML = `
        ...
        <a href="${this.profileUrl}" target="_blank" rel="noopener noreferrer" class="os-btn os-btn-primary" style="margin-top: 1rem; display: inline-flex;">
    ...
    if (this.container) {
      this.container.innerHTML = `
        <div class="gh-fallback-card glass-card">
          ...
          <p>Browse active code repositories, experiments, and security scripts directly on Sukesh D's GitHub profile.</p>
          <a href="${this.profileUrl}" target="_blank" rel="noopener noreferrer" class="os-btn os-btn-secondary" style="margin-top: 1rem;">
            Open https://github.com/sukeshd-me
          </a>
        </div>
      `;
    }
